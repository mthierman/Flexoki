...
const getTheme = (theme: string, color: string) => {
    ...
    return {
        ...
        colors: {
            ...
            "editorGroupHeader.tabsBackground": colors.secondary_bg,
            ...
            "input.background": colors.secondary_bg,
            ...
            "panel.background": colors.main_bg,
            "panel.border": colors.borders,
            "quickInput.background": colors.secondary_bg,
            ...
            "titleBar.inactiveBackground": colors.secondary_bg,
