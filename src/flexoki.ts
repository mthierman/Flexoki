...
export const generateTheme = (theme: Theme, accentColor: AccentColor) => {
    ...
    return {
        ...
        colors: {
            ...
            "editorGroupHeader.noTabsBackground": mapping["ui"]["main-background"],
            "editorGroupHeader.tabsBackground": mapping["ui"]["main-background"],
            ...
            "statusBar.background": mapping["ui"]["main-background"],
            ...
            "titleBar.activeBackground": mapping["ui"]["main-background"],
            "titleBar.activeForeground": mapping["ui"]["primary-text"],
            "titleBar.border": mapping["ui"]["borders"],
            "titleBar.inactiveBackground": mapping["ui"]["main-background"],
