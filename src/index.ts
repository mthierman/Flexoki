...
export const getTheme = (dark: boolean, color: string) => {
    ...
    return {
        ...
        colors: {
            ...
            "editorGroup.border": mappings["transparent"],
            "editorGroupHeader.border": dark ? mappings["ui-2"] : mappings["ui"],
            "editorGroupHeader.tabsBackground": dark ? mappings["ui"] : mappings["bg"],
            "editorGroupHeader.tabsBorder": dark ? mappings["ui-2"] : mappings["ui"],
