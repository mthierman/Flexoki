...
const generateTheme = (mode: Mode, accent: Accent) => {
    ...
    return {
        ...
        colors: {
            ...
            "button.secondaryBackground": ui["borders"],
            "button.secondaryForeground": ui["primary-text"],
            "button.secondaryHoverBackground": accentColor,
            "button.separator": ui["active-borders"],
            "dropdown.background": ui["main-background"],
            "dropdown.border": ui["borders"],
            "dropdown.foreground": ui["primary-text"],
            "dropdown.listBackground": ui["main-background"],
            ...
            "statusBar.debuggingForeground": ui["primary-text"],
            "statusBar.focusBorder": accentColor,
            "statusBar.foreground": ui["primary-text"],
            "statusBar.noFolderBackground": ui["borders"],
